        ...
        <div className="flex flex-col gap-3 pt-4 pr-2">
          <button
            ...
            className={`w-16 h-16 flex flex-col items-center justify-center rounded-lg transition-colors ${
              activeTab === 'design' ? 'bg-gray-200' : 'bg-white hover:bg-gray-50'
            }`}
          >
          ...
          <button
            ...
            className={`w-16 h-16 flex flex-col items-center justify-center rounded-lg transition-colors ${
              activeTab === 'transition' ? 'bg-gray-200' : 'bg-white hover:bg-gray-50'
            }`}
          >
          ...
          <button
            ...
            className={`w-16 h-16 flex flex-col items-center justify-center rounded-lg transition-colors ${
              activeTab === 'animation' ? 'bg-gray-200' : 'bg-white hover:bg-gray-50'
            }`}
          >
          ...
          <button
            ...
            className={`w-16 h-16 flex flex-col items-center justify-center rounded-lg transition-colors ${
              activeTab === 'ai' ? 'bg-purple-100' : 'bg-white hover:bg-gray-50'
            }`}
          >
